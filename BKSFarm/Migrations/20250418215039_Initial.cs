        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreate = table.Column<int>(type: "integer", nullable: false),
                    DieTime = table.Column<int>(type: "integer", nullable: false),
                    TimeToLvlUp = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Eggs_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlantStage = table.Column<string>(type: "text", nullable: false),
                    DateCreate = table.Column<int>(type: "integer", nullable: false),
                    DieTime = table.Column<int>(type: "integer", nullable: false),
                    TimeToLvlUp = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plants_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seeds_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Eggs_UserId1",
                table: "Eggs",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_Plants_UserId1",
                table: "Plants",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_Seeds_UserId1",
                table: "Seeds",
                column: "UserId1");
        }
